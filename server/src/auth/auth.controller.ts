...
export class AuthController {
  ...
  @Post('login')
  async login(@Body() dto: LoginDto, @Res({ passthrough: true }) res: Response, @UserAgent() agent: string) {
  ...
  @Get('refresh-tokens')
  async refreshTokens(@Cookie(REFRESH_TOKEN) refreshToken: string, @Res({ passthrough: true }) res: Response, @UserAgent() agent: string) {
    if (!refreshToken) {
